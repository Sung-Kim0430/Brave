...
- Verify settings: Admin → Theme Settings (notably per-page intro `intro*` options, `assetsSource`, `fontSource`, `enableDarkMode`, `enableCustomCode`, comment security options, and CSP/SRI toggles).
